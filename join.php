...
if (isset($_POST["submit"])) {
    ...
    $sql = "insert into users (uname,upass,role,added_date)
    values ('".$_POST['uname']."','".$_POST['upass']."','".$_POST['role']."','".date('Y-m-d h:i:s')."')";
  ...
  <form method="post">
    ...
    <div class="mb-3">
      ...
      <select class="form-control" name="role">
        ...
        <option value="menleader">Men leader</option>
        <option value="womenleader">Women leader</option>
